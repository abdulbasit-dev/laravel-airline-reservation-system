    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form class="needs-validation" novalidate action="{{ route('products.store') }}" autocomplete="off" method="POST" enctype="multipart/form-data" id="addProducyForm">
            @csrf
            <div class="row">
              <div class="col-8">
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="date" class="form-control" id="expire_at" autocomplete="new-expire-date" name="expire_at" value="{{ old('expire_at') }}" required>
                      <div class="valid-feedback">
                        @lang('validation.good')
                      </div>
                      <div class="invalid-feedback">
                ...
                <div class="mb-3">
                  ...
                  <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="is_box" id="box" value="true" required>
  ...
  <script type="text/javascript">
    ...
    $("#noBox").change(function() {
      if ($(this).is(":checked")) {
        ...
        $("#hasBox").find("input").removeAttr("required");
