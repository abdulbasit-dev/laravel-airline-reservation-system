...
@section('title')
  @lang('translation.exchange_history.exchange_history')
@endsection
...
@section('content')
  @component('components.breadcrumb')
    ...
    @endslot
    @slot('title')
      @lang('translation.exchange_history.exchange_history_list')
    @endslot
  @endcomponent
        ...
        <div class="card-body">
          <div class="d-flex justify-content-end mb-4" id="action_btns">
            ...
            <div class="btn-group mx-3">
              ...
              <div class="dropdown-menu" style="">
                <a class="dropdown-item" href="{{ route('exchange-history.export') }}">@lang('buttons.export')</a>
              </div>
            </div>
          ...
          <table id="datatable" class="table-hover table-bordered nowrap w-100 table">
            <thead class="table-light">
              <tr>
                <th>#</th>
                <th> @lang('translation.exchange_history.usd')</th>
                <th> @lang('translation.exchange_history.iqd')</th>
                <th> @lang('translation.exchange_history.action_by')</th>
  ...
  <script type="text/javascript">
    $(function() {
      let table = $('#datatable').DataTable({
        ...
        ajax: "{{ route('exchange-history.index') }}",
