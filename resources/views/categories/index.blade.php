...
@section('content')
  @component('components.breadcrumb')
    ...
    @endslot
    @slot('title')
      @lang('translation.category.category_list')
    @endslot
  @endcomponent
          ...
          <div class="d-flex justify-content-end mb-4" id="action_btns">
            ...
            <div class="btn-group mx-3">
              ...
              <div class="dropdown-menu" style="">
                <a class="dropdown-item" href="{{ route('categories.export') }}">@lang('buttons.export')</a>
                <a class="dropdown-item" href="{{ route('exportTemplate', ['excel', 'categories']) }}">@lang('buttons.export_template_excel')</a></a>
                <a class="dropdown-item" href="{{ route('exportTemplate', ['csv', 'categories']) }}">@lang('buttons.export_template_csv')</a></a>
                <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#importFile">@lang('buttons.import')</a>
              </div>
            </div>

            <a href="{{ route('categories.create') }}" class="btn btn-rounded btn-success waves-effect waves-light"><i class="bx bx-plus font-size-16 me-2 align-middle"></i>@lang('translation.category.add_category')</a>
