...
@section('title')
  @lang('translation.product.edit_product')
@endsection
    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form class="needs-validation" novalidate action="{{ route('products.update', $product) }}" autocomplete="off" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-8">
                ...
                <div class="mb-4">
                  ...
                  <textarea class="form-control" rows="3" name="description" id="description" required>{{ old('description', $product->description) }}</textarea>
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-control select2" id="supplier" name="supplier" required>
                        ...
                        @foreach ($suppliers as $key => $value)
                          <option value="{{ $key }}" @selected(old('category', $product->category_id) == $key)>{{ $value }}</option>
                        @endforeach
                      </select>
                      <div class="valid-feedback">
                        @lang('validation.good')
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="low_stock_quantity" name="low_stock_quantity" value="{{ old('low_stock_quantity', $product->low_stock_quantity) }}" required>
                      <div class="valid-feedback">
                        @lang('validation.good')
                      </div>
                      <div class="invalid-feedback">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="date" class="form-control" id="expire_at" autocomplete="new-expire-date" name="expire_at" value="{{ old('expire_at', $product->expire_at) }}" required>
                      <div class="valid-feedback">
                        @lang('validation.good')
                      </div>
                      <div class="invalid-feedback">
                ...
                <div class="mb-3">
                  ...
                  <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="is_box" id="box" value="true" @checked($product->is_box)>
                    <label class="form-check-label" for="box">
                      Box
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_box" id="noBox" value="false" @checked(!$product->is_box)>
                ...
                <div class="row" id="hasBox">
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control calculate" id="box_quantity" name="box_quantity" value="{{ old('box_quantity', $product->box_quantity) }}">
                      <div class="valid-feedback">
                        @lang('validation.good')
                      </div>
                      <div class="invalid-feedback">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="box_price" name="box_price" value="{{ old('box_price', $product->box_price) }}">
                      <div class="valid-feedback">
                        @lang('validation.good')
                      </div>
                      <div class="invalid-feedback">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control calculate" id="pcs_per_box" name="pcs_per_box" value="{{ old('pcs_per_box', $product->pcs_per_box) }}">
                      <div class="valid-feedback">
                        @lang('validation.good')
                      </div>
                      <div class="invalid-feedback">
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    //if no box is checked, then hide the box
    if ($("#noBox").is(":checked")) {
      $("#hasBox").hide();
    }
    ...
    Dropzone.options.myDropzone = {
      ...
      init: function() {
        ...
        myDropzone.displayExistingFile(mockFile, "{{ getFile($product) }}");
      }
    }
  </script>
@endsection
