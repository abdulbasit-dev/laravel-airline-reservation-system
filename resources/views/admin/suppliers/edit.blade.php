...
@section('title')
  @lang('translation.supplier.edit_supplier')
@endsection
    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form class="needs-validation" novalidate action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-8">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="tel" class="form-control" id="phone" name="phone" value="{{ old('phone', $supplier->phone) }}" required>
                    <div class="valid-feedback">
                      @lang('validation.good')
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="tel" class="form-control" id="phone_alt" name="phone_alt" value="{{ old('phone_alt', $supplier->phone_alt) }}" required>
                    <div class="valid-feedback">
                      @lang('validation.good')
                    </div>
                    <div class="invalid-feedback">
