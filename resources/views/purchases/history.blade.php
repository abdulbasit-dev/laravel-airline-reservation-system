          ...
          <table id="datatable" class="table-hover table-bpurchaseed w-100 table">
            <thead class="table-light">
              <tr>
                ...
                <th> @lang('translation.purchase.amount_paid')</th>
                <th> @lang('translation.purchase.safe_id')</th>
                <th> @lang('translation.purchase.usd_rate')</th>
                <th> @lang('translation.purchase.exchange_type')</th>
                <th> @lang('translation.purchase.date')</th>
  ...
  return parameterList.get(key)
    ...
    $(function() {
      ...
      if(getParameter('purchase')){
        ...
        ajax: {
          url:"{{ route('purchase-history.index') }}",
          method:"GET",
          data:function(d){
