    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          <form class="needs-validatio" novalidate action="{{ route('cars.store') }}" method="POST">
            @csrf
            <div class="row">
              <div class="col-xl-8">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="model" class="form-control" id="model" name="model" value="{{ old('model') }}" required>
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="plate_number" class="form-control" id="plate_number" name="plate_number" value="{{ old('plate_number') }}" required>
                    <div class="valid-feedback">
                      @lang('validation.good')
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-sm-9">
                    <select class="form-control select2" id="driver_name" name="driver" required>
                      ...
                      @foreach ($drivers as $key => $value)
                        <option value="{{ $key }}" @selected(old('driver') == $key)>{{ $value }}</option>
                      @endforeach
                    </select>
                    <div class="valid-feedback">
                      @lang('validation.good')
