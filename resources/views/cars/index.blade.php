          ...
          <div class="d-flex justify-content-end mb-4" id="action_btns">
            ...
            <div class="btn-group mx-3">
              ...
              <div class="dropdown-menu" style="">
                <a class="dropdown-item" href="{{ route('cars.export') }}">@lang('buttons.export')</a>
              </div>
            </div>

            <a href="{{ route('cars.create') }}" class="btn btn-rounded btn-success waves-effect waves-light"><i class="bx bx-plus font-size-16 me-2 align-middle"></i>@lang('translation.car.add_car')</a>
