                                ...
                                <div class="p-2">
                                 <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'admin@nawand.com') }}" id="username" placeholder="Enter Email" autocomplete="email" autofocus>
                                                @error('email')
